package similarity.highlevelop;
...
import similarity.graphconvert.GraphConvert;;
...
public class HighLevelOP {
	...
	public static double GetHighLevelOPSimilarity(Graph graph1, Graph graph2){
		...
		System.out.println("distance:"+distance+","+(opgraph1.nodes.size() +opgraph2.nodes.size() - common.size()));
